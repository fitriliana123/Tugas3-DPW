...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index3.html" class="brand-link">
      <img src="{{url('public')}}/dist/img/AdminLTELogo.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3"
           style="opacity: .8">
      <span class="brand-text font-weight-light">NANA CAKE'S</span>
    </a>
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="#" class="d-block">Fitri Liana</a>
        </div>
      </div>
      ...
      <nav class="mt-2">
        ...
        <li class="nav-item has-treeview menu-open">
            <a href="{{url('masterdata')}}/" class="nav-link {{checkRouteActive('masterdata')}}">
